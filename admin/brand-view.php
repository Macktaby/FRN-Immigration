...
require_once("includes/class/brand.php");?>
        ...
        <div class="right_col" role="main">
            <div class="page-title">
              <div class="title_left"><h3>Brand <small></small></h3></div>
            </div>
			<?php
				$Obj = new Brand();
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">				  
                    <p>Add new <a href="brand-add.php"><code>Brand</code></a></p>
						...
						<?php
								...
								if($num_rows >0){
									while($row = mysql_fetch_assoc($result)){
										...
										echo '<td class=" last"><a href="javascript:void(0);" onclick="Press('.$row['brand_id'].');" data-toggle="modal" data-target="#myModal">Delete</a>';
										echo '- <a href="brand-edit.php?id='.$row['brand_id'].'">Edit</a></td>';						
										echo'</tr>';
										$i++;
									}
								}
        ...
        <!-- /page content -->
		 ...
		 <div class="modal fade" id="myModal" tabindex="-1" role="dialog">
			...
			<form  method='post' action='brand-view.php' id="form1">
