          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Showroom all <small></small></h2>
                  ...
                  <div class="x_content">
                    <p>Add new <a href="showroom-add.php"><code>showroom</code></a></p>
					...
					if($num_rows >0){
						while($row = mysql_fetch_assoc($result)){
							...
							echo ' <td class=" ">'.$row['location'].'</td>';
							echo ' <td class=" ">'.$row['phone'].'</td>';
							echo ' <td class=" ">'.$row['image'].'</td>';
							echo '<td class=" last">';
							echo '<a href="javascript:void(0);" onclick="Press('.$row['showroom_id'].');" data-toggle="modal" data-target="#myModal">Delete</a>';
							echo '-';
							echo ' <a href="showroom-edit.php?id='.$row['showroom_id'].'">Edit</a></td>';
echo'</tr>';							
							$i++;
						}
					}
