...
?>
        ...
        <div class="right_col" role="main">
            <div class="page-title">
              <div class="title_left"><h3>users<small></small></h3></div>
            </div>
			<?php
				$Obj = new User();
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">		
                    ...
                    <p>Add new <a href="user-add.php"><code>Users</code></a></p>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Wishlist</th>
						...
						<?php
								...
								if($num_rows >0){
									while($row = mysql_fetch_assoc($result)){
										...
										echo ' <td class=" ">'.$row['nicename'].'</td>';
										echo ' <td class=" ">'.$row['phone'].'</td>';
										echo ' <td class=" ">'.$row['email'].'</td>';
										echo ' <td class=" ">'.$row['url'].'</td>';
										echo ' <td class=" "> <a href="user-view-wishlist.php?id='.$row['user_id'].'"> View</a></td>';
										echo ' <td class=" "> <a href="user-view-reservation.php?id='.$row['user_id'].'"> View </a></td>';
										echo ' <td class=" "> <a href="user-view-review.php?id='.$row['user_id'].'"> View </a></td>';
										echo '<td class=" last"><a href="javascript:void(0);" onclick="Press('.$row['user_id'].');" data-toggle="modal" data-target="#myModal">Delete</a>';
										echo '- <a href="user-edit.php?id='.$row['user_id'].'">Edit</a>';
										echo '- <a href="user-details-view.php?id='.$row['user_id'].'">View</a>';
